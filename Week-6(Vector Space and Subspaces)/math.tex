...
Since, $0 \in W_1$ and $0 \in W_2$, then by def\textsuperscript{n} $0 \in W_1+W_2$. Now, let $u, v \in W_1+W_2$.

Then, $u = x_1+x_2$ s.t. $x_1 \in W_1$, and $x_2 \in W_2$.

and $v = y_1+y_2$ s.t. $y_1 \in W_1$, and $y_2 \in W_2$.

$\therefore u+v = (x_1+x_2) + (y_1+y_2) = (x_1+y_1) + (x_2+y_2)$.

Now, since $x_1, y_1 \in W_1$ then $x_1+y_1 \in W_1$. Similarly, $x_2+y_2 \in W_2$.

Now, from the def\textsuperscript{n} $(x_1+y_1) + (x_2+y_2) = u+v \in W_1+W_2$.

Again, let $v \in W_1+W_2$ and $c \in F$. Then $v = x+y$ s.t. $x \in W_1$, and $y \in W_2$. By def\textsuperscript{n} of subspaces, $cx \in W_1$, and $cy \in W_2$. Then 
...
Let $v \in W_1+W_2$ then $v = x+y$ s.t $x \in W_1$, and $y \in W_2$. But we have, $W_1 \subseteq U$ and $W_2 \subseteq U$.
